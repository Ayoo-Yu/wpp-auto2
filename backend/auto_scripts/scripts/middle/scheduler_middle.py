...
def run_script():
    ...
    if not task_executed:
        ...
        exit_code = os.system(
            "conda activate D:\\my-vue-project\\wind-power-forecast\\backend\\env && python D:\\my-vue-project\\wind-power-forecast\\backend\\auto_scripts\\scripts\\middle\\auto_pre_train.py"
        )
        if exit_code == 0:

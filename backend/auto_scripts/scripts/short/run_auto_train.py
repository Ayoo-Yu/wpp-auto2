...
# 设置文件夹路径
dataset_folder = 'D:/my-vue-project/wind-power-forecast/backend/auto_scripts/dataset/dataset_short'
model_folder = 'D:/my-vue-project/wind-power-forecast/backend/auto_scripts/models/shortmodel'
train_result_folder = 'D:/my-vue-project/wind-power-forecast/backend/auto_scripts/train_predictions/short_predictions'

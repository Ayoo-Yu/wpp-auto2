...
# 设置文件夹路径
dataset_folder = 'D:/my-vue-project/wind-power-forecast/backend/auto_scripts/dataset/dataset_supershort'
model_folder = 'D:/my-vue-project/wind-power-forecast/backend/auto_scripts/models/supershortmodel'
train_result_folder = 'D:/my-vue-project/wind-power-forecast/backend/auto_scripts/train_predictions/supershort_predictions'
